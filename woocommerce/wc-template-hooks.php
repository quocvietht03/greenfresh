...
add_filter( 'loop_shop_per_page', 'greenfresh_loop_shop_per_page', 20 );
function greenfresh_loop_shop_per_page( $cols ) {
	global $greenfresh_options;
	$cols = (int) isset($greenfresh_options['shop_product_per_page']) ? $greenfresh_options['shop_product_per_page']: 10;
	return $cols;
}
