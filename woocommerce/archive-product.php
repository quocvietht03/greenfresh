...
$fullwidth = isset($greenfresh_options['shop_fullwidth'])&&$greenfresh_options['shop_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($greenfresh_options['shop_sidebar_width']) ? $greenfresh_options['shop_sidebar_width']: 3;
$sidebar_width_md = $sidebar_width + 1;

$shop_top_bar = isset($greenfresh_options['shop_top_bar']) ? $greenfresh_options['shop_top_bar']: false;
$shop_product_per_row = (int) isset($greenfresh_options['shop_product_per_row']) ? $greenfresh_options['shop_product_per_row']: 3;
