...
$manifest['id']                  = 'greenfresh';
$manifest['skin']                = 'main';
$manifest['name']                = esc_html__( 'Bearsthemes', 'greenfresh' );
$manifest['uri']                 = 'http://theme.bearsthemespro.com/greenfresh/';
$manifest['description']         = esc_html__( 'WordPress Theme', 'greenfresh' );
