...
$options = array(
	'menu_item_padding' => array(
		'label' => esc_html__('Menu Item Padding', 'greenfresh'),
		'desc' => esc_html__('Please enter number with px or % for menu item level 1 padding (default: 0px 10px)', 'greenfresh'),
		'type' => 'short-text',
		'value' => '0px 15px'
	),
	'sub_menu_padding' => array(
		'label' => esc_html__('Sub Menu Padding', 'greenfresh'),
		'desc' => esc_html__('Please enter number with px or % for sub menu padding (default: 0px)', 'greenfresh'),
		'type' => 'short-text',
		'value' => '0px'
	),
	'sub_menu_align' => array(
		...
		'choices' => array(
			'menu-align-left' => esc_html__('Left', 'greenfresh'),
			'menu-align-right' => esc_html__('Right', 'greenfresh'),
		),
		'inline' => true,
	),
	'badge' => array(
