...
$fullwidth = isset($greenfresh_options['single_services_fullwidth'])&&$greenfresh_options['single_services_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($greenfresh_options['single_services_sidebar_width']) ?  $greenfresh_options['single_services_sidebar_width']: 3;
...
$single_services_titlebar = isset($greenfresh_options['single_services_titlebar']) ? $greenfresh_options['single_services_titlebar']: true;
if($single_services_titlebar) greenfresh_titlebar();
?>
