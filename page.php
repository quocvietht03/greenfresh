...
$page_comment = (int)isset($greenfresh_options['page_comment']) ? $greenfresh_options['page_comment'] : 1;
$sidebar_width = (int)isset($greenfresh_options['sidebar_width']) ? $greenfresh_options['sidebar_width'] : 3;
