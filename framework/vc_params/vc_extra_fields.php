 ...
 */
function greenfresh_taxonomy_settings_field($settings, $value) {
...
greenfresh_add_extra_parame('bt_taxonomy', 'greenfresh_taxonomy_settings_field', get_template_directory_uri().'/assets/vc_extend/vc_taxonomy.js');

/*
 * Layout select list field
 */
function greenfresh_layout_settings_field($settings, $value) {
    $dependency = function_exists('vc_generate_dependencies_attributes') ? vc_generate_dependencies_attributes($settings) : '';
...
greenfresh_add_extra_parame('bt_layout', 'greenfresh_layout_settings_field', get_template_directory_uri().'/assets/vc_extend/vc_layout.js');
