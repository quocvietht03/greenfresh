...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'shop', 'greenfresh' ),
	'id'               => 'bt_shop',
	...
	'fields'           => array(
		...
		array(
			'id'       => 'shop_top_bar',
			'type'     => 'switch',
			'title'    => esc_html__( 'Enable Top Bar', 'greenfresh' ),
			'subtitle' => esc_html__( 'Turn on to show the top bar on the top.', 'greenfresh' ),
			'default'  => false
		),
		array(
			...
			'right'   => false,
			'left'   => false,
			'title'    => esc_html__( 'Top Bar Space', 'greenfresh' ),
			'subtitle' => esc_html__( 'Control the bottom margin the top bar.', 'greenfresh' ),
			'default'  => array(
				'margin-bottom' => '30px'
			),
		...
		array(
			...
			'type'          => 'slider',
			'title'         => esc_html__( 'Product Per Page', 'greenfresh' ),
			'subtitle'      => esc_html__( 'Controls the number of product on the page.', 'greenfresh' ),
			'default'       => 10,
			'min'           => 1,
			'step'          => 1,
			'max'           => 20,
		...
		array(
			...
			'type'          => 'slider',
			'title'         => esc_html__( 'Product Per Row', 'greenfresh' ),
			'subtitle'      => esc_html__( 'Controls the number of product on the row.', 'greenfresh' ),
			'default'       => 3,
			'min'           => 2,
			'step'          => 1,
			'max'           => 4,
...
Redux::setSection( $opt_name, array(
	'title'            => esc_html__( 'Single Product', 'greenfresh' ),
	'id'               => 'bt_product',
	'subsection'       => true,
	'fields'           => array(
		array(
