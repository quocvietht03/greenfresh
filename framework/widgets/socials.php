...
class greenfresh_Social_Widget extends WP_Widget {
    function __construct(){
        parent::__construct(
            'social_widget', // Base ID
            esc_html__('Socials', 'greenfresh'), // Name
            array('description' => esc_html__('Social Widget', 'greenfresh'),) // Args
        );
    }
    ...
    function form($instance){
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'greenfresh'); ?></label>
        ...
        for ($i = 1; $i <= 12; $i++) {
            ?>
            <p>
                <label for="<?php echo esc_url($this->get_field_id('icon_social_' . $i)); ?>"><?php echo esc_html__('Social Icon', 'greenfresh') . $i; ?></label>
            ...
            <p>
                <label for="<?php echo esc_url($this->get_field_id('link_social_' . $i)); ?>"><?php echo esc_html__('Social Link', 'greenfresh') . $i; ?></label>
        ...
        <?php } ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('el_class')); ?>"><?php _e('Extra Class', 'greenfresh'); ?></label>
...
/**
 * Class greenfresh_Social_Widget
 */
function greenfresh_register_social_widget(){
    register_widget('greenfresh_Social_Widget');
}

add_action('widgets_init', 'greenfresh_register_social_widget');
?>
