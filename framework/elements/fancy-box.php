...
vc_map(array(
	'name' => esc_html__('Fancy Box', 'greenfresh'),
	'base' => 'bt_fancy_box',
	...
	'params' => array(
		...
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Content Space', 'greenfresh'),
			...
			'description' => esc_html__('Please, enter number with px space between content and icon in this element. Ex: 60px', 'greenfresh')
		),
		...
		array(
			...
			'description' => esc_html__('Please, enter class font icon in this element.', 'greenfresh')
		),
		array(
			'type' => 'attach_image',
		...
		array(
			'type' => 'dropdown',
			'heading' => esc_html__('Icon Style', 'greenfresh'),
			'param_name' => 'icon_style',
			'value' => array(
				esc_html__('None', 'greenfresh') => '',
				esc_html__('Square', 'greenfresh') => 'square',
				esc_html__('Rounded', 'greenfresh') => 'rounded',
				esc_html__('Circle', 'greenfresh') => 'circle'
			),
			'group' => esc_html__('Icon', 'greenfresh'),
			'description' => esc_html__('Select style icon in this elment.', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Icon Size', 'greenfresh'),
			...
			'description' => esc_html__('Please, enter number size icon in this element. Ex: 60px', 'greenfresh')
		),
		array(
			'type' => 'textfield',
		...
		array(
			...
			'description' => esc_html__('Select border style icon in this elment.', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			...
			'description' => esc_html__('Please, enter number with px border width icon in this element. Ex: 2px', 'greenfresh')
		),
		array(
			'type' => 'colorpicker',
			...
			'description' => esc_html__('Select border color icon in this element.', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Space', 'greenfresh'),
			'param_name' => 'icon_space',
			'value' => '',
			'group' => esc_html__('Icon', 'greenfresh'),
			'description' => esc_html__('Please, enter number with px space between icon and content in this element. Ex: 30px', 'greenfresh')
		),
		array(
			'type' => 'textfield',
		...
		array(
			...
			'group' => esc_html__('Title', 'greenfresh'),
			'description' => esc_html__('Add custom link of the title in this element.', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Font Size', 'greenfresh'),
		...
		array(
			...
			'value' => '',
			'group' => esc_html__('Title', 'greenfresh'),
			'description' => esc_html__('Please, enter number with px space between title and description in this element. Ex: 15px', 'greenfresh')
		),
		array(
			'type' => 'textarea_html',
			'heading' => esc_html__('Description', 'greenfresh'),
			'param_name' => 'content',
			'value' => '',
			'group' => esc_html__('Description', 'greenfresh'),
			'description' => esc_html__('Please, enter description in this element.', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Font Size', 'greenfresh'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'greenfresh'),
			'description' => esc_html__('Please, enter number  with px font size description in this element. Ex: 14px', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Line Height', 'greenfresh'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'greenfresh'),
			'description' => esc_html__('Please, enter number with px line height description in this element. Ex: 24px', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Letter Spacing', 'greenfresh'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'greenfresh'),
			'description' => esc_html__('Please, enter number with px letter spacing description in this element. Ex: 1px', 'greenfresh')
		),
		array(
			'type' => 'colorpicker',
			'heading' => esc_html__('Color', 'greenfresh'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'greenfresh'),
			'description' => esc_html__('Select color description in this element.', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Space', 'greenfresh'),
			...
			'value' => '',
			'group' => esc_html__('Description', 'greenfresh'),
			'description' => esc_html__('Please, enter number with px space between description and read more in this element. Ex: 15px', 'greenfresh')
		),
		array(
			'type' => 'vc_link',
			'heading' => esc_html__('URL (Link)', 'greenfresh'),
			'param_name' => 'link',
			'group' => esc_html__('Extra Link', 'greenfresh'),
			'description' => esc_html__('Add extra link in this element.', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Font Size', 'greenfresh'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'greenfresh'),
			'description' => esc_html__('Please, enter number  with px font size extra link in this element. Ex: 14px', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Line Height', 'greenfresh'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'greenfresh'),
			'description' => esc_html__('Please, enter number with px line height extra link in this element. Ex: 24px', 'greenfresh')
		),
		array(
			'type' => 'textfield',
			'heading' => esc_html__('Letter Spacing', 'greenfresh'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'greenfresh'),
			'description' => esc_html__('Please, enter number with px letter spacing extra link in this element. Ex: 1px', 'greenfresh')
		),
		array(
			'type' => 'colorpicker',
			'heading' => esc_html__('Color', 'greenfresh'),
			...
			'value' => '',
			'group' => esc_html__('Extra Link', 'greenfresh'),
			'description' => esc_html__('Select color extra link in this element.', 'greenfresh')
		),
		array(
			'type' => 'css_editor',
