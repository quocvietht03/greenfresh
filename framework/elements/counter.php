...
vc_map(array(
    'name'     => esc_html__('Counter', 'greenfresh'),
    'base'     => 'bt_counter',
    ...
    'params'   => array(
        ...
        array(
            ...
            'value'       => array(
                esc_html__('Icon class', 'greenfresh') => 'type_class',
                esc_html__('Icon image', 'greenfresh') => 'type_image',
            ),
            'std'         => 'type_class',
            'group'       => esc_html__('Icon', 'greenfresh'),
            'admin_label' => true,
            'description' => esc_html__('Please, select icon type element.', 'greenfresh')
        ),
        array(
            'type'        => 'attach_image',
        ...
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Icon class', 'greenfresh'),
            ...
            'group'       => esc_html__('Icon', 'greenfresh'),
            'admin_label' => true,
            'description' => esc_html__('Please, enter icon class element.', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            ...
            'group'       => esc_html__('Icon', 'greenfresh'),
            'description' => esc_html__('Please, enter icon with px font size number in this element. Ex: 45px', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            ...
            'group'       => esc_html__('Icon', 'greenfresh'),
            'description' => esc_html__('Please, enter icon with px line height number in this element. Ex: 50px', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            ...
            'group'       => esc_html__('Icon', 'greenfresh'),
            'description' => esc_html__('Please, enter icon with px letter spacing number in this element. Ex: 1.2px', 'greenfresh')
        ),
        array(
            'type'        => 'colorpicker',
        ...
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Before Number', 'greenfresh'),
            'param_name'  => 'before_number',
            'value'       => '',
            'group'       => esc_html__('Number', 'greenfresh'),
            'admin_label' => true,
            'description' => esc_html__('Please, enter before number in this element.', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('After Number', 'greenfresh'),
            'param_name'  => 'after_number',
            'value'       => '',
            'group'       => esc_html__('Number', 'greenfresh'),
            'admin_label' => true,
            'description' => esc_html__('Please, enter after number in this element.', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Number', 'greenfresh'),
            'param_name'  => 'number',
            'value'       => '',
            'group'       => esc_html__('Number', 'greenfresh'),
            'admin_label' => true,
            'description' => esc_html__('Please, enter number in this element.', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Font Size', 'greenfresh'),
            ...
            'value'       => '',
            'group'       => esc_html__('Number', 'greenfresh'),
            'description' => esc_html__('Please, enter number with px font size number in this element. Ex: 45px', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            ...
            'value'       => '',
            'group'       => esc_html__('Number', 'greenfresh'),
            'description' => esc_html__('Please, enter number font weight number in this element. Ex: 700', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Line Height', 'greenfresh'),
            ...
            'value'       => '',
            'group'       => esc_html__('Number', 'greenfresh'),
            'description' => esc_html__('Please, enter number with px line height number in this element. Ex: 50px', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Letter Spacing', 'greenfresh'),
            ...
            'value'       => '',
            'group'       => esc_html__('Number', 'greenfresh'),
            'description' => esc_html__('Please, enter number with px letter spacing number in this element. Ex: 1.2px', 'greenfresh')
        ),
        array(
            'type'        => 'colorpicker',
            'heading'     => esc_html__('Color', 'greenfresh'),
            ...
            'value'       => '',
            'group'       => esc_html__('Number', 'greenfresh'),
            'description' => esc_html__('Select color number in this element.', 'greenfresh')
        ),
        //Title
        array(
            'type'        => 'textfield',
        ...
        array(
            ...
            'value'       => '',
            'group'       => esc_html__('Title', 'greenfresh'),
            'description' => esc_html__('Please, enter number font weight title in this element. Ex: 400', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Line Height', 'greenfresh'),
        ...
        array(
            ...
            'value'       => '',
            'group'       => esc_html__('Title', 'greenfresh'),
            'description' => esc_html__('Please, enter number with px font size sub title in this element. Ex: 14px', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Font Weight', 'greenfresh'),
            ...
            'value'       => '',
            'group'       => esc_html__('Title', 'greenfresh'),
            'description' => esc_html__('Please, enter number font weight sub title in this element. Ex: 400', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Line Height', 'greenfresh'),
