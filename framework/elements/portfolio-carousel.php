...
class WPBakeryShortCode_bt_portfolio_carousel extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null){
        ...
        wp_add_inline_script('greenfresh-main', $data_script);
...
vc_map(array(
    'name'     => esc_html__('Portfolio Carousel', 'greenfresh'),
    ...
    'params'   => array(
        ...
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Read more', 'greenfresh'),
            'param_name'  => 'readmore_text',
            'value'       => 'View Project',
            'group'       => esc_html__('Item Setting', 'greenfresh'),
            'description' => esc_html__('Hidden if empty.', 'greenfresh'),
        ),
        array(
            'type'        => 'textfield',
        ...
        array(
            ...
            'value'       => 0,
            'group'       => esc_html__('Owl Setting', 'greenfresh'),
            'description' => esc_html__('Margin-right(px) on item. Ex: 30', 'greenfresh')
        ),
        array(
            'type'        => 'checkbox',
