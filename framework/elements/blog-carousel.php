...
class WPBakeryShortCode_bt_blog_carousel extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null){
        ...
        $custom_script = "jQuery(window).on('load', function() {
							if (jQuery('.bt-blog-carousel-element .owl-carousel').length) {
								jQuery('.bt-blog-carousel-element .owl-carousel').each(function() {
...
vc_map(array(
    'name'     => esc_html__('Blog Carousel', 'greenfresh'),
