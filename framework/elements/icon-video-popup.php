...
class WPBakeryShortCode_bt_icon_video_popup extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null){
        ...
        if ($icon_type == 'font_icon') {
            ...
            $icon = $attachment_image[0] ? '<img src="' . esc_url($attachment_image[0]) . '" alt="' . esc_attr__('Thumbnail', 'greenfresh') . '"/>' : '';
        }
...
vc_map(array(
    'name'     => esc_html__('Icon Video Popup', 'greenfresh'),
    ...
    'params'   => array(
        array(
            ...
            'param_name'  => 'title',
            'value'       => '',
            'description' => esc_html__('Enter the title.', 'greenfresh')
        ),
        array(
            'type'        => 'vc_link',
            'heading'     => esc_html__('Video URL (Link)', 'greenfresh'),
            'param_name'  => 'video_link',
            'description' => esc_html__('Add video link of the icon in this element.', 'greenfresh')
        ),
        array(
            'type'        => 'dropdown',
