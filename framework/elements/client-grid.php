...
vc_map(array(
	'name' => esc_html__('Client Logo Grid', 'greenfresh'),
	'base' => 'bt_client_grid',
	...
	'params' => array(
		array(
			...
			'param_name' => 'columns',
			'value' => array(
				esc_html__('6 Items', 'greenfresh') => 'col-6',
				esc_html__('5 Items', 'greenfresh') => 'col-5',
				esc_html__('4 Items', 'greenfresh') => 'col-4',
				esc_html__('3 Items', 'greenfresh') => 'col-3',
				esc_html__('2 Items', 'greenfresh') => 'col-2',
				esc_html__('1 Item', 'greenfresh') => 'col-1'
			),
