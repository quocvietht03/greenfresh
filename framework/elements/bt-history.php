...
vc_map(array(
    'name'     => esc_html__('History Timeline', 'greenfresh'),
    'base'     => 'bt_history',
    ...
    'params'   => array(
        array(
            ...
            'param_name'  => 'time',
            'value'       => '2018',
            'description' => esc_html__('Enter your time.', 'greenfresh'),
            'admin_label' => true
        ),
        array(
            'type'        => 'textfield',
            ...
            'description' => esc_html__('Enter your title.', 'greenfresh'),
            'admin_label' => true
        ),
        array(
            'type'        => 'textarea_html',
            'heading'     => esc_html__('Content', 'greenfresh'),
            'param_name'  => 'content',
            'value'       => 'Stet gubergren no sea takimata sanctus est Lorem ipsum dolor sit amet ipsumlor eut consetetur.',
            'description' => esc_html__('Enter your content.', 'greenfresh'),
            'group'      => esc_html__('Content', 'greenfresh'),
        ),
