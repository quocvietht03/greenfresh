...
vc_map(array(
    'name'     => esc_html__('Careers Box', 'greenfresh'),
    'base'     => 'bt_careers_box',
    ...
    'params'   => array(
        ...
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Job Title', 'greenfresh'),
            'param_name'  => 'title',
            'value'       => 'Management',
            'group'       => esc_html__('Job Title', 'greenfresh'),
            'admin_label' => true,
        ...
        array(
            ...
            'group'       => esc_html__('Job Info', 'greenfresh'),
            'description' => esc_html__('Please, enter description in this element.', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Working time', 'greenfresh'),
            'param_name'  => 'working_time',
            'value'       => 'Fulltime',
            'group'       => esc_html__('Job Info', 'greenfresh'),
            'description' => esc_html__('Please, enter working time in this element.', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Date Description', 'greenfresh'),
            'param_name'  => 'date_des',
            'value'       => 'Submission Date:',
            'group'       => esc_html__('Job Info', 'greenfresh'),
            'description' => esc_html__('Please, enter Date Description in this element.', 'greenfresh')
        ),
        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Date expiry', 'greenfresh'),
            'param_name'  => 'date_exp',
            'value'       => '30th Mar 2019',
            'group'       => esc_html__('Job Info', 'greenfresh'),
            'description' => esc_html__('Please, enter Date expiry in this element.', 'greenfresh')
        ),

        array(
            'type'        => 'textfield',
            'heading'     => esc_html__('Button text', 'greenfresh'),
            'param_name'  => 'career_btn',
            'value'       => 'Apply Now!',
            'group'       => esc_html__('Button', 'greenfresh'),
            'description' => esc_html__('Please, enter Button text in this element.', 'greenfresh')
        ),
        array(
            'type'        => 'vc_link',
            'heading'     => esc_html__('URL (Link)', 'greenfresh'),
            ...
            'group'       => esc_html__('Button', 'greenfresh'),
            'description' => esc_html__('Add custom link of the button in this element.', 'greenfresh')
        ),
