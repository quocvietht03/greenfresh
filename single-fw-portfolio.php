...
$fullwidth = isset($greenfresh_options['single_portolio_fullwidth'])&&$greenfresh_options['single_portolio_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($greenfresh_options['single_portolio_sidebar_width']) ?  $greenfresh_options['single_portolio_sidebar_width']: 3;
$sidebar_width_md = $sidebar_width + 1;
$related_post = isset($greenfresh_options['single_portfolio_related_post']) ? $greenfresh_options['single_portfolio_related_post']: true;
$related_post_label = isset($greenfresh_options['single_portfolio_related_post_label'])&&$greenfresh_options['single_portfolio_related_post_label'] ? $greenfresh_options['single_portfolio_related_post_label']: esc_html__('Portfolio Related', 'greenfresh');
$related_post_count = (int) isset($greenfresh_options['single_portfolio_related_post_count'])&&$greenfresh_options['single_portfolio_related_post_count'] ? $greenfresh_options['single_portfolio_related_post_count']: 3;
$related_post_per_row = (int) isset($greenfresh_options['single_portfolio_related_post_per_row'])&&$greenfresh_options['single_portfolio_related_post_per_row'] ? $greenfresh_options['single_portfolio_related_post_per_row']: 3;
...
$single_portfolio_titlebar = isset($greenfresh_options['single_portfolio_titlebar']) ? $greenfresh_options['single_portfolio_titlebar']: true;
if($single_portfolio_titlebar) greenfresh_titlebar();
?>
