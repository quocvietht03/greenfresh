...
$fullwidth = isset($greenfresh_options['single_team_fullwidth'])&&$greenfresh_options['single_team_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($greenfresh_options['single_team_sidebar_width']) ?  $greenfresh_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($greenfresh_options['single_team_titlebar']) ? $greenfresh_options['single_team_titlebar']: true;
if($single_team_titlebar) greenfresh_titlebar();
?>
